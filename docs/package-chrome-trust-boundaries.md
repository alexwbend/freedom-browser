...
package chrome. The payments window reads recent
...
broader non-provider vault management still require additional shell-owned
surface migration before wallet UX can be called complete in package mode.
