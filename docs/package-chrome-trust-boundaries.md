...
those same parsed payment-review details when signing needs an unlock, but
still dismiss and pass the original 402 through. Package chrome still cannot
receive raw x402 IPC, unlock vault state, edit/revoke x402 caps, write
arbitrary payment permissions, or read payment history. File/folder/full
publish UX, richer account selection/review, x402 permission management, and
vault unlock still need main-derived guest/request context and real
