...
- `xvfb-run -a npm run test:e2e -- test-e2e/chrome-smoke.spec.js test-e2e/chrome-package.spec.js` passed:
  14 tests.
- committed as `cdf4935` (`feat(chrome): open trusted wallet approval prompt`)
  and pushed to `origin/goal/local-package-chrome-runtime-v0`.
- GitHub Actions run `28100884928`, job `test` (`83202287560`), passed for
  `cdf4935`.
- GitHub Actions run `28100884928`, job `e2e-chrome-runtime`
  (`83202287557`), passed for `cdf4935`.
...
- `xvfb-run -a npm run test:e2e -- test-e2e/chrome-smoke.spec.js test-e2e/chrome-package.spec.js` passed:
  14 tests.
- committed as `24ffa31` (`feat(chrome): open trusted swarm publish surface`)
  and pushed to `origin/goal/local-package-chrome-runtime-v0`.
- GitHub Actions run `28104234451`, job `test` (`83213982247`), passed for
  `24ffa31`.
- GitHub Actions run `28104234451`, job `e2e-chrome-runtime`
  (`83213982427`), passed for `24ffa31`.
...
- `git diff --check` passed.
- committed as `4478767` (`feat(chrome): export keys from trusted wallet
  surface`) and pushed to `origin/goal/local-package-chrome-runtime-v0`.
- GitHub Actions run `28105620288`, job `test` (`83218946231`), passed for
  `4478767`.
- GitHub Actions run `28105620288`, job `e2e-chrome-runtime`
  (`83218946284`), passed for `4478767`.
