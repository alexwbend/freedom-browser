...
describe('preload', () => {
  ...
  test('registers electronAPI, github bridge, and service registry listeners with cleanup', () => {
    ...
    const listenerCases = [
      ...
      [exposures.sitePermissions, 'onPromptRequest', IPC.PERMISSIONS_PROMPT_REQUEST, [{ id: 1, origin: 'https://example.com', keys: ['camera'] }], [{ id: 1, origin: 'https://example.com', keys: ['camera'] }]],
