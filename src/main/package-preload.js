...
const SHELL_API_METHODS = Object.freeze({
  ...
  BROWSER_STATE_HISTORY_REMOVE: 'browserState.history.remove',
  BROWSER_STATE_HISTORY_CLEAR: 'browserState.history.clear',
  BROWSER_STATE_FAVICONS_GET: 'browserState.favicons.get',
  BROWSER_STATE_FAVICONS_GET_CACHED: 'browserState.favicons.getCached',
  BROWSER_STATE_FAVICONS_FETCH: 'browserState.favicons.fetch',
  BROWSER_STATE_FAVICONS_FETCH_WITH_KEY: 'browserState.favicons.fetchWithKey',
...
const freedomShell = Object.freeze({
  ...
  removeHistory: (id) => invokeShell(SHELL_API_METHODS.BROWSER_STATE_HISTORY_REMOVE, { id }),
  clearHistory: () => invokeShell(SHELL_API_METHODS.BROWSER_STATE_HISTORY_CLEAR),
  getFavicon: (url) => invokeShell(SHELL_API_METHODS.BROWSER_STATE_FAVICONS_GET, url),
  getCachedFavicon: (url) =>
    invokeShell(SHELL_API_METHODS.BROWSER_STATE_FAVICONS_GET_CACHED, url),
  fetchFavicon: (url) => invokeShell(SHELL_API_METHODS.BROWSER_STATE_FAVICONS_FETCH, url),
  fetchFaviconWithKey: (fetchUrl, cacheKey) =>
    invokeShell(SHELL_API_METHODS.BROWSER_STATE_FAVICONS_FETCH_WITH_KEY, {
      fetchUrl,
      cacheKey,
    }),
