...
const SHELL_API_METHOD_CAPABILITIES = Object.freeze({
  ...
  [SHELL_API_METHODS.THEME_GET]: SHELL_API_CAPABILITIES.SHELL_INFO,
  ...
  [SHELL_API_METHODS.BROWSER_STATE_SETTINGS_SAVE]:
    SHELL_API_CAPABILITIES.BROWSER_STATE_SETTINGS_WRITE,
  ...
  [SHELL_API_METHODS.BROWSER_STATE_FAVICONS_GET]:
    SHELL_API_CAPABILITIES.BROWSER_STATE_FAVICONS_WRITE,
  ...
  [SHELL_API_METHODS.BROWSER_STATE_PROFILES_GET_ACTIVE]:
    SHELL_API_CAPABILITIES.BROWSER_STATE_PROFILES_READ,
  [SHELL_API_METHODS.BROWSER_STATE_PROFILES_LIST]:
    SHELL_API_CAPABILITIES.BROWSER_STATE_PROFILES_READ,
  [SHELL_API_METHODS.SERVICES_GET_REGISTRY]: SHELL_API_CAPABILITIES.SERVICES_READ,
  [SHELL_API_METHODS.SERVICES_GET_STATUS]: SHELL_API_CAPABILITIES.SERVICES_READ,
  [SHELL_API_METHODS.SERVICES_CHECK_BINARY]: SHELL_API_CAPABILITIES.SERVICES_READ,
  ...
  [SHELL_API_METHODS.CHROME_UI_UPDATE_TAB_MENU_STATE]:
    SHELL_API_CAPABILITIES.CHROME_UI_COMMANDS,
  [SHELL_API_METHODS.CHROME_UI_SET_BOOKMARK_BAR_TOGGLE_ENABLED]:
    SHELL_API_CAPABILITIES.CHROME_UI_COMMANDS,
  [SHELL_API_METHODS.CHROME_UI_SET_BOOKMARK_BAR_CHECKED]:
    SHELL_API_CAPABILITIES.CHROME_UI_COMMANDS,
  [SHELL_API_METHODS.CLIPBOARD_COPY_TEXT]: SHELL_API_CAPABILITIES.CLIPBOARD_WRITE,
  [SHELL_API_METHODS.CLIPBOARD_COPY_IMAGE_FROM_URL]: SHELL_API_CAPABILITIES.CLIPBOARD_WRITE,
  [SHELL_API_METHODS.DOWNLOADS_SAVE_IMAGE]: SHELL_API_CAPABILITIES.DOWNLOADS_SAVE_IMAGE,
});

const SHELL_API_EVENT_CAPABILITIES = Object.freeze({
  [SHELL_API_EVENTS.THEME_CHANGED]: SHELL_API_CAPABILITIES.SHELL_INFO,
  ...
  [SHELL_API_EVENTS.CHROME_CLOSE_MENUS_REQUESTED]: SHELL_API_CAPABILITIES.CHROME_UI_COMMANDS,
  [SHELL_API_EVENTS.CHROME_FOCUS_ADDRESS_BAR_REQUESTED]:
    SHELL_API_CAPABILITIES.CHROME_UI_COMMANDS,
  [SHELL_API_EVENTS.CHROME_TOGGLE_DEVTOOLS_REQUESTED]:
    SHELL_API_CAPABILITIES.CHROME_UI_COMMANDS,
  [SHELL_API_EVENTS.CHROME_CLOSE_DEVTOOLS_REQUESTED]: SHELL_API_CAPABILITIES.CHROME_UI_COMMANDS,
  [SHELL_API_EVENTS.CHROME_CLOSE_ALL_DEVTOOLS_REQUESTED]:
    SHELL_API_CAPABILITIES.CHROME_UI_COMMANDS,
  [SHELL_API_EVENTS.CHROME_NEW_TAB_REQUESTED]: SHELL_API_CAPABILITIES.CHROME_UI_COMMANDS,
  [SHELL_API_EVENTS.CHROME_CLOSE_TAB_REQUESTED]: SHELL_API_CAPABILITIES.CHROME_UI_COMMANDS,
  [SHELL_API_EVENTS.CHROME_NEW_TAB_WITH_URL_REQUESTED]:
    SHELL_API_CAPABILITIES.CHROME_UI_COMMANDS,
  [SHELL_API_EVENTS.CHROME_NAVIGATE_TO_URL_REQUESTED]:
    SHELL_API_CAPABILITIES.CHROME_UI_COMMANDS,
  [SHELL_API_EVENTS.CHROME_LOAD_URL_REQUESTED]: SHELL_API_CAPABILITIES.CHROME_UI_COMMANDS,
  [SHELL_API_EVENTS.CHROME_RELOAD_REQUESTED]: SHELL_API_CAPABILITIES.CHROME_UI_COMMANDS,
  [SHELL_API_EVENTS.CHROME_HARD_RELOAD_REQUESTED]: SHELL_API_CAPABILITIES.CHROME_UI_COMMANDS,
  [SHELL_API_EVENTS.CHROME_NEXT_TAB_REQUESTED]: SHELL_API_CAPABILITIES.CHROME_UI_COMMANDS,
  [SHELL_API_EVENTS.CHROME_PREV_TAB_REQUESTED]: SHELL_API_CAPABILITIES.CHROME_UI_COMMANDS,
  [SHELL_API_EVENTS.CHROME_MOVE_TAB_LEFT_REQUESTED]: SHELL_API_CAPABILITIES.CHROME_UI_COMMANDS,
  [SHELL_API_EVENTS.CHROME_MOVE_TAB_RIGHT_REQUESTED]: SHELL_API_CAPABILITIES.CHROME_UI_COMMANDS,
  [SHELL_API_EVENTS.CHROME_REOPEN_CLOSED_TAB_REQUESTED]:
    SHELL_API_CAPABILITIES.CHROME_UI_COMMANDS,
  [SHELL_API_EVENTS.CHROME_TOGGLE_BOOKMARK_BAR_REQUESTED]:
    SHELL_API_CAPABILITIES.CHROME_UI_COMMANDS,
  [SHELL_API_EVENTS.APP_UPDATE_NOTIFICATION]: SHELL_API_CAPABILITIES.APP_UPDATES,
  [SHELL_API_EVENTS.BROWSER_STATE_PROFILE_UPDATED]:
    SHELL_API_CAPABILITIES.BROWSER_STATE_PROFILES_READ,
  [SHELL_API_EVENTS.SERVICES_REGISTRY_UPDATED]: SHELL_API_CAPABILITIES.SERVICES_READ,
  [SHELL_API_EVENTS.SERVICES_STATUS_UPDATED]: SHELL_API_CAPABILITIES.SERVICES_READ,
  [SHELL_API_EVENTS.SURFACES_STATE_CHANGED]: SHELL_API_CAPABILITIES.SURFACES_WALLET_CONTROL,
});
