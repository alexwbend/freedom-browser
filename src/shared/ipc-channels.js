...
module.exports = {
  ...
  DAPP_PROVIDER_TRUSTED_PROMPT_REQUEST: 'dapp:provider-trusted-prompt-request',
  ...
  SHELL_CANVAS_COMMAND: 'shell-canvas:command',
  SHELL_CANVAS_READY: 'shell-canvas:ready',
