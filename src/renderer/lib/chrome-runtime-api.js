...
const createPackageRuntimeApi = () =>
  Object.freeze({
    ...
    startSwarmProbe: async () => ({ ok: false, reason: 'package-runtime-unavailable' }),
    awaitSwarmProbe: async () => ({ ok: false, reason: 'package-runtime-unavailable' }),
    cancelSwarmProbe: asyncSuccess,
